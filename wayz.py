...
### BANNER OR LOGO ###
def banner_logo():
    os.system('cls' if os.name == 'nt' else 'clear') # Coded by Rz
...
def dapatkan_nama(cookie, token_eaag):
    with requests.Session() as r:
        r.headers.update({
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 8.1.0; 7; LH9810 Build/OPM2.171019.012; wv)A958T) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.4651.105 Mobile Safari/537.36',
            'cookie': cookie
        })
